...
$jobs = [
    [
        "jobName" => "Администратор группы",
        "startDate" => "Январь 2023",
        "endDate" => "Настоящее время",
        "description" => "Работаю администратором группы в вк."
    ],
    [
        "jobName" => "Бухгалтер",
        "startDate" => "Апрель 2012",
        "endDate" => "Декабрь 2021",
        "description" => "Ведение бух.учета."
    ],
    [
        "jobName" => "Секретарь",
        "startDate" => "Февраль 2010",
        "endDate" => "Март 2012",
        ...
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          <h2 class="w3-text-grey w3-padding-16"><i
              ...
              <?php for ($i = 0; $i < count($jobs); $i++): ?>
                <div class="w3-container">
                    <h5 class="w3-opacity"><b> <?php echo $jobs[$i]['jobName']?> </b></h5>
                    <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>
                    <?php echo $jobs[$i]['startDate']?> - 
                    <?php if ($i == 0): ?>
                        <span class="w3-tag w3-teal w3-round">
                            <?php echo $jobs[$i]['endDate']?></h6>
                        </span>
                    <?php else: ?>
                            <?php echo $jobs[$i]['endDate']?></h6>
                    <?php endif; ?>
